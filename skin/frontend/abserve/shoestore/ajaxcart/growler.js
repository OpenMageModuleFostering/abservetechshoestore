...
Growler = (function(){
	...
	return Class.create({
		...
		,warn: function(msg, options){
			return specialNotice(this.growler, msg, options, "Warning!", "#f2dede", "#a94442");
		}
		,error: function(msg, options){
			return specialNotice(this.growler, msg, options, "Critical!", "#f2dede", "#a94442");
		}
		,info: function(msg, options){
			return specialNotice(this.growler, msg, options, "Information!", "#dff0d8", "#3c763d");
		}
